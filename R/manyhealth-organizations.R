...
#'\itemize{
#' \item{CHATHAM: }{
#' [1] S. J. Hoffman, C. B. Cole, and M. Pearcey. _Mapping global health architecture to inform thefuture_. Chatham House London, 2015.}
#' \item{IHEID: }{
#' [1] _Directory of Global Health Actors_. 2021.}
#' \item{GHS: }{
#' [1] S. J. Hoffman and C. B. Cole. “Defining the global health system and systematically mapping itsnetwork of actors”. In: _Global Health_ 14.38 (2018). DOI: 10.1186/s12992-018-0340-2.}
#' }
#' @section URL:
#'\itemize{
#' \item{CHATHAM: }{ \url https://www.chathamhouse.org/sites/default/files/field/field_document/20150120GlobalHealthArchitectureHoffmanColePearcey.pdf}
#' \item{IHEID: }{ \url https://www.graduateinstitute.ch/GHC-directories}
#' \item{GHS: }{ \url https://doi.org/10.1186/s12992-018-0340-2}
#' }
#' @section Mapping:
#'\itemize{
#' \item{CHATHAM: }{
