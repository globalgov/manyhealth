...
The **Texts** database assembles treaty texts from the **Agreements** database. Functions from `{manypkgs}` can then be used to analysis treaty texts, some specific articles or preambles.
...
This code below illustrates how to extract sample of treaties from the references database and how to plot their links to other treaties. The dataset selected to this end, GHHR_REF, also includes agreements on human rights. For more information on how to read the manyID, please read the [vignette](https://globalgov.github.io/manypkgs/articles/agreements.html) from `{manypkgs}` package.
